        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Penalties_Families_FamilyId",
                        column: x => x.FamilyId,
                        principalTable: "Families",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeOfDay = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    SortOrder = table.Column<int>(type: "integer", nullable: false),
                    IsArchived = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    FamilyId = table.Column<Guid>(type: "uuid", nullable: false),
                    ChildMemberId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_Members_AuthorMemberId",
                        column: x => x.AuthorMemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_Members_ChildMemberId",
                        column: x => x.ChildMemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Purchases_Families_FamilyId",
                        column: x => x.FamilyId,
                        principalTable: "Families",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Purchases_Members_ChildMemberId",
                        column: x => x.ChildMemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Purchases_Members_ResolvedByMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: false),
                    ChildComment = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Status = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Submissions_Members_ChildMemberId",
                        column: x => x.ChildMemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Submissions_Members_ReviewedByMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Penalties_FamilyId_IsArchived",
                table: "Penalties",
                columns: new[] { "FamilyId", "IsArchived" });

            migrationBuilder.CreateIndex(
                name: "IX_Purchases_ChildMemberId_CreatedAt",
                table: "Purchases",
                columns: new[] { "ChildMemberId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Purchases_FamilyId_Status_CreatedAt",
                table: "Purchases",
                columns: new[] { "FamilyId", "Status", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Purchases_ResolvedByMemberId",
                table: "Purchases",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rewards_FamilyId_IsArchived",
                table: "Rewards",
                columns: new[] { "FamilyId", "IsArchived" });

            migrationBuilder.CreateIndex(
                name: "IX_Submissions_ChildMemberId_SubmittedAt",
                table: "Submissions",
                columns: new[] { "ChildMemberId", "SubmittedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Submissions_FamilyId_Status_SubmittedAt",
                table: "Submissions",
                columns: new[] { "FamilyId", "Status", "SubmittedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Submissions_ReviewedByMemberId",
                table: "Submissions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_FamilyId_IsArchived",
                table: "Tasks",
                columns: new[] { "FamilyId", "IsArchived" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_AuthorMemberId",
                table: "Transactions",
                column: "AuthorMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ChildMemberId_CreatedAt",
                table: "Transactions",
                columns: new[] { "ChildMemberId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_FamilyId_CreatedAt",
                table: "Transactions",
